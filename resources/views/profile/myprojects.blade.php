<x-app-layout>
    <div class="flex justify-between items-center py-5 px-12 bg-white  shadow-sm">
        <h1 class="font-semibold text-xl text-black-800 dark:text-black-200 leading-tight">
            {{ __('My Projects') }}
        </h1>
        <button type="button" class=" flex items-center space-x-2 p-2 bg-blue-700 hover:bg-blue-600 text-white rounded-full">
            {{ __('+ Create Project') }}
        </button>
    </div>
    <div class="">
      <div  >
        <div id="card" class="py-2 px-4"></div>
      </div>
            <!-- Regions List -->
            <script>
                const regions = [
