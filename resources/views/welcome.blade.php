        ...
        @else
            <style>
                ...
                *,:before,:after{box-sizing:border-box;border-width:0;border-style:solid;border-color:#e5e7eb}
                ...
                .w-5{width:1.25rem}
                .w-\[calc\(100\%_\+_8rem\)\]{width:calc(100% + 8rem)}
                .w-auto{width:auto}
                .w-full{width:100%}
                ...
                .shadow-\[0px_14px_34px_0px_rgba\(0\,0\,0\,0\.08\)\]{--tw-shadow: 0px 14px 34px 0px rgba(0,0,0,.08);--tw-shadow-colored: 0px 14px 34px 0px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000),var(--tw-ring-shadow, 0 0 #0000),var(--tw-shadow)}
                ...
                .selection\:bg-\[\#FF2D20\] *::-moz-selection{--tw-bg-opacity: 1;background-color:rgb(255 45 32 / var(--tw-bg-opacity, 1))}
                .selection\:bg-\[\#FF2D20\] *::selection{--tw-bg-opacity: 1;background-color:rgb(255 45 32 / var(--tw-bg-opacity, 1))}
                .selection\:bg-\[\#FF2D20\]::-moz-selection{--tw-bg-opacity: 1;background-color:rgb(255 45 32 / var(--tw-bg-opacity, 1))}
                .selection\:bg-\[\#FF2D20\]::selection{--tw-bg-opacity: 1;background-color:rgb(255 45 32 / var(--tw-bg-opacity, 1))}
                ...
                .focus-visible\:ring-\[\#FF2D20\]:focus-visible{--tw-ring-opacity: 1;--tw-ring-color: rgb(255 45 32 / var(--tw-ring-opacity, 1))}
                ...
                .dark\:bg-black{--tw-bg-opacity: 1;background-color:rgb(0 0 0 / var(--tw-bg-opacity, 1))}
                .dark\:bg-gray-800{--tw-bg-opacity: 1;background-color:rgb(31 41 55 / var(--tw-bg-opacity, 1))}
                .dark\:bg-zinc-900{--tw-bg-opacity: 1;background-color:rgb(24 24 27 / var(--tw-bg-opacity, 1))}
                ...
                .dark\:ring-zinc-800{--tw-ring-opacity: 1;--tw-ring-color: rgb(39 39 42 / var(--tw-ring-opacity, 1))}
                ...
                .dark\:hover\:ring-zinc-700:hover{--tw-ring-opacity: 1;--tw-ring-color: rgb(63 63 70 / var(--tw-ring-opacity, 1))}
                ...
                .dark\:focus-visible\:ring-\[\#FF2D20\]:focus-visible{--tw-ring-opacity: 1;--tw-ring-color: rgb(255 45 32 / var(--tw-ring-opacity, 1))}
                .dark\:focus-visible\:ring-white:focus-visible{--tw-ring-opacity: 1;--tw-ring-color: rgb(255 255 255 / var(--tw-ring-opacity, 1))}
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <h1 class="text-3xl font-mono font-semibold text-white text-center">
                                NCIP Project Monitoring System
                            </h1>
                        </div>
                        @if (Route::has('login'))
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black dark:text-white">Overview</h2>

                                            <p class="mt-4 text-sm/relaxed text-justify">
                                            A Monitoring System for MOVs of Action Plans enables executives to track, evaluate, and make data-driven decisions based on real-time submissions of supporting documents. It streamlines action plan management through automated tracking, reporting, and compliance monitoring while ensuring transparency and accountability. With data analytics, role-based access, and system integration, it enhances strategic decision-making and organizational efficiency.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Realtime Monitoring</h2>

                                    <p class="mt-4 text-sm/relaxed text-justify">
                                        The system provides real-time monitoring of submitted MOVs, allowing executives to track progress instantly. Automated notifications and dashboards ensure that stakeholders remain informed about deadlines, compliance status, and pending submissions. This proactive approach minimizes delays, enhances accountability, and enables swift decision-making based on the latest data. With live updates and seamless integration, the system fosters efficiency and transparency in action plan execution.
                                    </p>
                                </div>
                            </a>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">File Management</h2>

                                    <p class="mt-4 text-sm/relaxed text-justify">
                                        The system offers a structured and secure approach to managing MOVs and other supporting documents. It enables users to upload, categorize, and retrieve files efficiently, ensuring easy access to relevant information. Version control and audit trails help maintain data integrity, while role-based permissions safeguard sensitive documents. With centralized storage and seamless integration, the system enhances document organization, compliance, and long-term accessibility.
                                    </p>
                                </div>
                            </a>
                            ...
                            <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Integrated Dashboards</h2>

                                    <p class="mt-4 text-sm/relaxed text-justify">
                                        The system features integrated dashboards that provide executives and stakeholders with a comprehensive view of action plan progress. These dashboards display key performance indicators, submission statuses, and compliance metrics in real time, enabling data-driven decision-making.
                                    </p>
                                </div>
                            </div>
                        </div>
